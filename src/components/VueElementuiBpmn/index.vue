        ...
        <el-main class="fm2-main">
            <el-container class="center-container">
                ...
                <el-aside class="widget-config-container">
                    <property-panel ref="_propertyPanel" v-if="modeler" :modeler="modeler"
...
<script>
    ...
    export default {
        ...
        components: {VueAceEditor, PropertyPanel},
        data() {
            return {
        ...
        methods: {
            ...
            handleSave() {
                const _this = this
                this.$refs._propertyPanel?.validate().then(() => {
